...
The theoretical $O(Tn^2)$ complexity of randomized algorithms matches the
...
The primary sources of deviation between theory and practice:
...
The $R^2 > 0.95$ correlation for polynomial algorithms confirms that $O(\cdot)$
