...
offering probabilistic guarantees or empirically good performance. We
distinguish two paradigms:
\begin{itemize}
...
Section~\ref{sec:results} describes our experimental methodology and results.
