...
\subsubsection{Graph Generation. Random graphs were generated with the following parameters}
...
\subsubsection{External Datasets Used}

The Maximum Weight Clique benchmark instances from Zenodo~\cite{trimble2017mwc}
were used to test scalability on real-world graphs, providing a diverse
...
\subsubsection{Metrics Measured}
\begin{itemize}
...
10,000 and edge densities from 12.5\% to 75\%. The selected algorithms
represent distinct paradigms:
