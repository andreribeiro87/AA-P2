...
Clique (MWC) problem, with particular emphasis on randomized approaches.
Fourteen algorithms spanning four categories were implemented and evaluated:
randomized methods, reduction-based techniques, exact branch-and-bound
algorithms, and additional heuristics.

\subsection{Summary of Findings}

The experimental evaluation on 364 generated graphs and real-world network
...
\begin{itemize}
    \item \textbf{Best overall:} \texttt{fast\_wclq} --- near-optimal solutions (99.92\% average) with excellent speed
